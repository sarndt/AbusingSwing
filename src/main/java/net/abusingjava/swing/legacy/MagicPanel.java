...
import net.abusingjava.swing.legacy.BalloonTipFactory.Balloon;
import net.abusingjava.swing.legacy.Magic.Button;
import net.abusingjava.swing.legacy.Magic.CheckBox;
import net.abusingjava.swing.legacy.Magic.ComboBox;
import net.abusingjava.swing.legacy.Magic.DatePicker;
import net.abusingjava.swing.legacy.Magic.Numeric;
import net.abusingjava.swing.legacy.Magic.Panes;
import net.abusingjava.swing.legacy.Magic.Table;
import net.abusingjava.swing.legacy.Magic.Tabs;
import net.abusingjava.swing.legacy.Magic.TextField;
		...
		try {
			...
			$b1.setEntityResolver(new EntityResolver() {
				...
				public InputSource resolveEntity(String $publicId, String $systemId) throws SAXException, IOException {
					if ("-//abusingjava.net//net.abusingjava.swing.legacy.MagicPanel//EN".equals($publicId))
