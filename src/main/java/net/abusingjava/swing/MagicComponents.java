...
@Version("2011-07-26")
@Since("2011-07-26")
final public class MagicComponents {
	...
	public MagicComponents(final net.abusingjava.swing.Magic.Component $definition) {
		$magic = new Magic.Component[] { $definition };
	}

	public MagicComponents(final List<net.abusingjava.swing.Magic.Component> $list) {
